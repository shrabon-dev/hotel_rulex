...
import offerOne from '../../assets/images/offers/880x712_img3.jpg'
import offerTwo from '../../assets/images/offers/880x712_img4.jpg'
import offerThree from '../../assets/images/offers/880x712_img5.jpg'
    ...
    <section id='offers' className='py-32'>
        ...
        <div className="offers_box">
            ...
            <div className="offers w-full h-full relative  ">
                <div className="offers_img w-full h-full">
                    <picture>
                         <img className='block h-full w-full' src={offerThree} alt={offerThree} />
                    </picture>
                </div>
                <div className="offers_info absolute  z-[99] left-1/2 -translate-x-1/2 bottom-0">
                    <div className="ofr_card p-6 md:p-10 relative bg-white after:absolute after:w-full after:content-[''] after:h-full after:border after:border-dark after:-top-6 after:-right-8 after:z-[-1]  md:pt-20 before:absolute before:w-full before:content-[''] before:h-full before:border before:border-secondary before:-top-8 before:-right-10 before:z-[-2] mx-auto md:w-[615px]">
            ...
            <div className="offers w-full h-full relative  ">
                <div className="offers_img w-full h-full">
                    <picture>
                         <img className='block h-full w-full' src={offerTwo} alt={offerTwo} />
                    </picture>
                </div>
                <div className="offers_info absolute  z-[99] left-1/2 -translate-x-1/2 bottom-0">
                    <div className="ofr_card p-6 md:p-10 relative bg-white after:absolute after:w-full after:content-[''] after:h-full after:border after:border-dark after:-top-6 after:-right-8 after:z-[-1]  md:pt-20 before:absolute before:w-full before:content-[''] before:h-full before:border before:border-secondary before:-top-8 before:-right-10 before:z-[-2] mx-auto md:w-[615px]">
