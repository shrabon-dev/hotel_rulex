...
import bg_img from '../../assets/images/1920x1064_bg.jpg'
        ...
        <div className="overlay bg-dark/45 pt-72">
          <div className="container_box">
            <div className="title text-center">
              <h4 className='font-roboto font-normal text-center text-sm md:text-lg uppercase flex items-center justify-center gap-5 text-white tracking-[5px]'><picture><img   src={title_line} alt={title_line} /></picture> Time to reconnect </h4>
            </div>
            <h1 className='font-anglecia font-normal text-4xl leading-[1.3] md:text-[72px] text-white text-center pt-5 md:pt-0 pb-[28px]'>A New Vision Of Comfort</h1>
            <div className="play_btn text-center">
              <span className='w-20 group h-20 mx-auto inline-block border flex justify-center items-center rounded-full cursor-pointer border-white'>
                 <IoMdPlay className='inline-block text-white text-4xl group-hover:text-5xl duration-300 ease-in-out' />
              </span>
              <p className='font-roboto font-normal text-xs tracking-[2px] uppercase text-white pt-2'>WATCH THE FILM</p>
            </div>
          </div>
          <div className="booking_form bg-black/60 py-10 md:py-20 mt-20 md:mt-52 ">
            <div className="container_box">
