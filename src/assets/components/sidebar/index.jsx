...
export default function Sidebar(props) {
  return (
    <>
     <aside >
        <div className={`sidebar w-72 h-screen  ${props.mode ? 'duration-300 ease-in-out oipacity-100 left-0':'duration-300 ease-in-out opacity-0 -left-96'} bg-dark overflow-auto fixed z-[999999] top-0 py-20 px-10 `}>
