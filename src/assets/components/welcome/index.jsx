        ...
        <div className="flex py-32">
            ...
            <div className="container_box relative z-[99] -right-16 px-0">
                ...
                <h2 className='font-anglecia pb-10 font-normal leading-[1.7] text-dark_title text-4xl block'><span className='block text-6xl'>Luxury Hotel </span>
                 ...
                 <p className='text-lg pb-4 font-roboto font-bold text-dark_title leading-[1.7] justify w-[450px] '>Aliquam erat volutpat. Duis ac turpis. Donec sit amet eros. Lorem ipsum dolor sit amet, consectetuer adipiscing elit..</p>
                 <p className='text-lg font-roboto font-normal text-dark_title  leading-[1.7] justify w-[450px]'>Mauris fermentum dictum magna. Sed laoreet aliquam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit. Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis. Integer rutrum ante eu lacus.</p>
                    <a href="#" className='font-roboto pt-10 text-lg text-third font-medium tracking-[1px] flex items-center gap-10'>
